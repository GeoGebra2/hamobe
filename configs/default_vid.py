...
_C.DATA.ROOT = '/research/cvlshare/cvl-suyiyan1/MEVID'
...
_C.DATA.TRAIN_BATCH = 24
# Batch size for testing
_C.DATA.TEST_BATCH = 8
...
_C.LOSS = CN()
# Classification loss
_C.LOSS.CLA_LOSS = 'cosface'  #'crossentropy'
...
_C.TRAIN.LR_SCHEDULER.STEPSIZE = [70, 140]
